...
def run_processes_sequentially():
    ...
    try:
            ...
            if file.split("-")[0] not in md_list and file.endswith(".md"):
                ...
                try:
                    ...
                    if process.returncode == 0:
                        ...
                        print(f"❌ Process {process_number} failed with return code: {process.returncode}")
        ...
        print(f"📊 Total processes handled: {processed_count}")
        if i % 5 == 0:
            percentage_complete = (i / n) * 100
            bullet.push("Processes", f"{percentage_complete:.2f}% Processos concluídos")
...
if __name__ == "__main__":
    print("🚀 Starting EPROC Sequential Process Runner")
    print("="*60)
    run_processes_sequentially()
